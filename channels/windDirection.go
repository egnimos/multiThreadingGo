...
func main() {
	...
	absPath, _ := filepath.Abs("/home/niteeshdubey/Documents/Workspace/GOLANG/multiThreadingGo/metarfiles/")
...
func parseToArray(textChannels chan string, metarChannel chan []string) {
	// text := <- textChannels
	for text := range textChannels {
